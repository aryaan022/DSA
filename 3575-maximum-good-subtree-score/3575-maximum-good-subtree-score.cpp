...
public:
    ...
    // isGood Function is used to check whether the given number has any digit already present in mask before
    ...
    // This function is used to get the maximum sum from each subset arising from each nodes of the tree
    ...
    // The dfs function is used to form all the subsets from the nodes
    ...
    //    Get the sum from all the nodes
        for (int i = 0; i < n; i++) {
